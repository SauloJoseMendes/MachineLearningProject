...
from tensorflow.keras.layers import Input, Dense, Flatten, Concatenate, LeakyReLU, Dropout
...
x_numeric = Dense(16)(numeric_input)
...
x_image = Dense(16)(x_image)
x_image = LeakyReLU()(x_image)
